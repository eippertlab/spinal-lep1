...
def run_CCA(subject_id, condition, trigger, sampling_rate, input_path, save_path, folder):
    plot_graphs = True
    fname = f'ssp6_cleaned_{condition}.fif'
    figure_path_spatial = f'/data/pt_02889/{folder}/esg_analysis/cca/ComponentIsopotentialPlots/sub-{subject_id}/'
    figure_path_time = f'/data/pt_02889/{folder}/esg_analysis/cca/ComponentTimePlots/sub-{subject_id}/'
    figure_path_st = f'/data/pt_02889/{folder}/esg_analysis/cca/ComponentSinglePlots/sub-{subject_id}/'
    figure_path = f'/data/pt_02889/{folder}/esg_analysis/cca/ComponentPlots/sub-{subject_id}/'
    ...
    if condition in ['pain', 'cold']:
        raw.filter(l_freq=0.5, h_freq=150, n_jobs=len(raw.ch_names), method='iir', iir_params={'order': 4, 'ftype': 'butter'},
                   phase='zero')
    ...
    if condition == 'pain':
        ...
        # window_times = [30/1000, 190/1000]  # Testing for laser
        window_times = [60/1000, 100/1000]  # Testing for laser
