...
# Apply CCA to anteriorly rereferenced data with 30Hz hpf applied
...
def run_CCA_hpf30_anterior(subject_id, condition, trigger, sampling_rate, input_path, save_path, folder):
    plot_graphs = True
    fname = f'ssp6_cleaned_{condition}.fif'
    figure_path_spatial = f'/data/pt_02889/{folder}/esg_analysis/cca_hpf30_anterior/ComponentIsopotentialPlots/sub-{subject_id}/'
    figure_path_time = f'/data/pt_02889/{folder}/esg_analysis/cca_hpf30_anterior/ComponentTimePlots/sub-{subject_id}/'
    figure_path_st = f'/data/pt_02889/{folder}/esg_analysis/cca_hpf30_anterior/ComponentSinglePlots/sub-{subject_id}/'
    figure_path = f'/data/pt_02889/{folder}/esg_analysis/cca_hpf30_anterior/ComponentPlots/sub-{subject_id}/'
